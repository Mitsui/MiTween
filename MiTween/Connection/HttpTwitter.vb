...
Public Class HttpTwitter
    ...
    Private ConsumerKey As String = EncryptString("9HkMwlCnNgX3ueT9QAWQ")
    '''<summary>
    '''OAuthの署名作成用秘密コンシューマーデータ
    '''</summary>
    'Private Const ConsumerSecret As String = "M0IMsbl2722iWa+CGPVcNeQmE+TFpJk8B/KW9UUTk3eLOl9Ij005r52JNxVukTzM"
    Private ConsumerSecret As String = EncryptString("aArawiEGCQW6zeAeewg1p6OfeYL5Ybnbz5qlcKnKHqA")
    '''<summary>
    ...
    Public Function SendDirectMessage(ByVal status As String, ByVal sendto As String, ByRef content As String) As HttpStatusCode
        ...
        Return httpCon.GetContent(PostMethod,
                                  CreateTwitterUri("/1/direct_messages/nw.json"),
                                  param,
                                  content,
                                  Nothing,
                                  Nothing)
