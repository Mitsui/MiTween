...
Public NotInheritable Class MiTweenAboutBox
    ...
    Private Sub TweenAboutBox_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'Me.LabelVersion.Text = String.Format(My.Resources.TweenAboutBox_LoadText2, fileVersion + "(" + My.Application.Info.Version.ToString + ")") 'アセンプリバージョンあり
        Me.LabelVersion.Text = String.Format(My.Resources.TweenAboutBox_LoadText2, fileVersion) 'アセンプリバージョンなし
