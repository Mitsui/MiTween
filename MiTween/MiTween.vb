...
'           (c) 2011-2012 Mitsui3Tweet3 (@Mitsui3Tweet3) <https://twitter.com/Mitsui3Tweet3>
' All rights reserved.
' 
...
Imports MiTween.TweenCustomControl
Imports System.IO
Imports System.Web
...
Public Class TweenMain
    ...
    Private Sub InitColumnText()
        ...
        ColumnText(0) = "Icon"                          'アイコン
        ColumnText(1) = My.Resources.AddNewTabText2     'ニックネーム
        ColumnText(2) = My.Resources.AddNewTabText3     '本文
        ColumnText(3) = My.Resources.AddNewTabText4_2   '時刻=発言Id
        ColumnText(4) = My.Resources.AddNewTabText5     '名前
        ColumnText(5) = ""                              '未読
        ColumnText(6) = "Fav"                           'ファボ
        ColumnText(7) = "Source"                        'Source

        ColumnOrgText(0) = "Icon"
...
#If DEBUG Then
        TraceOutToolStripMenuItem.Checked = False
        TraceFlag = True
#End If
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If _cfgCommon.AutoShortUrlFirst < 0 Then
            _cfgCommon.AutoShortUrlFirst = MiTween.UrlConverter.Bitly
        End If
    ...
    Private Sub MyList_RetrieveVirtualItem(ByVal sender As System.Object, ByVal e As System.Windows.Forms.RetrieveVirtualItemEventArgs)
        ...
        Else
            ...
            Dim tb As TabPage = DirectCast(DirectCast(sender, MiTween.TweenCustomControl.DetailsListView).Parent, TabPage)
            Try
...
RETRY:
    ...
    Private Sub SetMainWindowTitle()
        ...
        ttl.Append("MiTween " + fileVersion + " ")
...
#End If
    ...
    Private Sub StartUserStream()
        ...
        StopToolStripMenuItem.Text = "開始(&S)"
